...
struct EndGameView: View {
    ...
    private var stats: [(String, String)] {
        [("Avg time", session.avgTime), ("Total Items", "\(session.items)"),
    ...
    @ViewBuilder private func congrats(_ space: DesignSpace) -> some View {
        ...
        statRow("Total Item value", total, End.labelSize, End.valueSize, Ink.black,
                CGRect(x: End.column.minX, y: End.totalY, width: End.column.width, height: End.rowH),
                space)
        artButton("Back to Home", "eg_button", End.button, End.buttonArt, space, onHome)
    ...
    @ViewBuilder private func jailed(_ space: DesignSpace) -> some View {
        ...
        artButton("Back to Home", "jail_button", End.jailButton, End.jailButtonArt, space, onHome)
    }
    ...
    @ViewBuilder private func failed(_ space: DesignSpace) -> some View {
        ...
        artButton("Back to Home", "fail_button", End.failButton, End.failButtonArt, space, onHome)
    ...
    private func tally(_ at: CGPoint, _ width: CGFloat, _ space: DesignSpace) -> some View {
        Group {
            ...
            statRow("Total Item value", total, End.labelSize, End.valueSize, .black,
